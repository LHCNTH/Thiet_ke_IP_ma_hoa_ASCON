...
HD_PWD='D:/Vivado/Thiet_ke_IP_ma_hoa_ASCON/Thiet_ke_IP_ma_hoa_ASCON.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ascon_decrypt_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ascon_decrypt_top.tcl -notrace
