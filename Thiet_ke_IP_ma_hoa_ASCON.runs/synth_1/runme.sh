...
HD_PWD='D:/Vivado/Thiet_ke_IP_ma_hoa_ASCON/Thiet_ke_IP_ma_hoa_ASCON.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ascon_decrypt_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ascon_decrypt_top.tcl
